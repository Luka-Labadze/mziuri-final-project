              ...
              <tr>
                <td align="center"
                  ...
                  <p style="margin:0;font-size:12px;color:#888888;letter-spacing:0.5px;">
                    ...
                    &nbsp;/&nbsp;
                    <span style="color:#555555;">Password Reset</span>
                  </p>
                </td>
              </tr>
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                      <td style="padding:20px 24px;">
                        ...
                        <p style="margin:0 0 12px 0;font-size:15px;color:#333333;line-height:1.7;">
                          Someone requested to reset the password for this account.
                        </p>
